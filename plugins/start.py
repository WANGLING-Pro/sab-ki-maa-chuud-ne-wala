...
# ===== Fixed text reply for non-admins (no buttons) =====
from pyrogram import filters
from pyrogram.types import Message

# Channel username for fixed reply
CHANNEL_USERNAME = os.getenv("<b><blockquote>♲︎︎︎ Pᴏᴡᴇʀᴇᴅ Bʏ : @P_world_81🔞</blockquote></b>")  # aapka channel
